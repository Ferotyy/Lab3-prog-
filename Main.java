public class Main {
    ...
    public static void story(Neznayka neznayka, Cashier kassir,Seeds seeds,Shorty korotishka,AbstractPlace place,Shorty ponchik,
        ...
        System.out.println(neznayka.GetName()+ " " + neznayka.getMove1()+", если " + neznayka.move2 +
                " для " + korotishka.GetName() + " и " + neznayka.getMove3() + " "+ ponchik.GetName());
    ...
    public static void main(String[] args) {
        Neznayka neznayka = new Neznayka("Незнайка", "будет доволен","достанет семена", "выручит");
